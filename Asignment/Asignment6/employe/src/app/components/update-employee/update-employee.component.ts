...
export class UpdateEmployeeComponent implements OnInit {
  ...
  constructor(public AuthService:AuthService,public router:Router, activateRoute: ActivatedRoute) {
    this.employee_id = activateRoute.snapshot.params.id
   }
   ...
   get confirmPassword(){
     ...
     update(){
       ...
       this.AuthService.update(this.form.inputData.value, this.employee_id).subscribe((res)=>{
         if(res){
